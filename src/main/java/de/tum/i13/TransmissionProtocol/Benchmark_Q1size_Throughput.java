...
public class Benchmark_Q1size_Throughput {
...
//        List<Integer> q1SizeToTest = List.of(10,20,50,100,200,500,1000,2000,5000,10000);
//        List<Integer> q1SizeToTest = List.of(1,10,100,500,1000,1500,2000,2500,3000,3500,4000,4500,5000);
...
//            System.out.println("Token:");
        ...
        for (int q1Size: q1SizeToTest
            ...
            for (int i = 0; i < noIterations; i++) {
                ...
                for (int k = 0; k < noSequencesPerIteration ; k++) {
                    restClient.runBenchmarkingSequence(token, "Evaluation", "test" + token, queriesString, delayBetweenOps, resultCalculationDelay,q1Size);
                }
                Thread.sleep(delayBetweenBenchmarks);
            }
